...
export const STOCK_DATABASE: StockEntry[] = [
  ...
  // ══════════════════════════════════════════════════════════
  // EU — Local Listings (유럽 현지 상장)
  // ══════════════════════════════════════════════════════════
  { ticker: "ASML.AS",  ko: "에이에스엠엘",        en: "ASML Holding (Amsterdam)",     exchange: "EU",    sector: "반도체장비" },
  { ticker: "SAP.DE",   ko: "SAP",               en: "SAP SE (Frankfurt)",            exchange: "EU",    sector: "기업소프트웨어" },
  { ticker: "SIE.DE",   ko: "지멘스",             en: "Siemens AG (Frankfurt)",        exchange: "EU",    sector: "산업자동화" },
  { ticker: "MC.PA",    ko: "LVMH",              en: "LVMH (Paris)",                  exchange: "EU",    sector: "명품" },
  { ticker: "OR.PA",    ko: "로레알",             en: "L'Oréal (Paris)",               exchange: "EU",    sector: "뷰티" },
  { ticker: "AIR.PA",   ko: "에어버스",            en: "Airbus SE (Paris)",             exchange: "EU",    sector: "항공" },
  { ticker: "NESN.SW",  ko: "네슬레",             en: "Nestlé (Zurich)",               exchange: "EU",    sector: "식품" },
  { ticker: "ROG.SW",   ko: "로슈",               en: "Roche Holding (Zurich)",        exchange: "EU",    sector: "제약/진단" },
  { ticker: "NOVN.SW",  ko: "노바티스",            en: "Novartis (Zurich)",             exchange: "EU",    sector: "제약" },
  { ticker: "SHEL.L",   ko: "쉘",                en: "Shell PLC (London)",            exchange: "EU",    sector: "에너지" },
  { ticker: "HSBA.L",   ko: "HSBC",              en: "HSBC Holdings (London)",        exchange: "EU",    sector: "금융" },
  { ticker: "AZN.L",    ko: "아스트라제네카",       en: "AstraZeneca (London)",          exchange: "EU",    sector: "제약" },
  { ticker: "BP.L",     ko: "BP",                en: "BP PLC (London)",               exchange: "EU",    sector: "에너지" },
  { ticker: "GSK.L",    ko: "GSK",               en: "GSK plc (London)",              exchange: "EU",    sector: "제약" },
  { ticker: "ULVR.L",   ko: "유니레버",            en: "Unilever PLC (London)",         exchange: "EU",    sector: "소비재" },
  { ticker: "RIO.L",    ko: "리오 틴토",           en: "Rio Tinto (London)",            exchange: "EU",    sector: "광업" },
  { ticker: "BHP",      ko: "BHP 그룹",           en: "BHP Group",                     exchange: "NYSE",  sector: "광업" },
  { ticker: "RACE",     ko: "페라리",             en: "Ferrari N.V.",                  exchange: "NYSE",  sector: "자동차" },
  { ticker: "NVO",      ko: "노보 노디스크",        en: "Novo Nordisk (ADR)",            exchange: "NYSE",  sector: "제약" },
  { ticker: "NOVO-B.CO",ko: "노보 노디스크",        en: "Novo Nordisk B (Copenhagen)",   exchange: "EU",    sector: "제약" },
  { ticker: "BAYN.DE",  ko: "바이엘",             en: "Bayer AG (Frankfurt)",          exchange: "EU",    sector: "제약/화학" },
  { ticker: "BMW.DE",   ko: "BMW",               en: "BMW AG (Frankfurt)",            exchange: "EU",    sector: "자동차" },
  { ticker: "MBG.DE",   ko: "메르세데스-벤츠",      en: "Mercedes-Benz Group (Frankfurt)",exchange: "EU",   sector: "자동차" },
  { ticker: "VOW3.DE",  ko: "폭스바겐",            en: "Volkswagen AG (Frankfurt)",     exchange: "EU",    sector: "자동차" },
  { ticker: "ALV.DE",   ko: "알리안츠",            en: "Allianz SE (Frankfurt)",        exchange: "EU",    sector: "보험" },
  { ticker: "BNP.PA",   ko: "BNP 파리바",          en: "BNP Paribas (Paris)",           exchange: "EU",    sector: "금융" },
  { ticker: "SAN.PA",   ko: "사노피",             en: "Sanofi (Paris)",                exchange: "EU",    sector: "제약" },
  { ticker: "INGA.AS",  ko: "ING 그룹",           en: "ING Groep (Amsterdam)",         exchange: "EU",    sector: "금융" },
  { ticker: "PHIA.AS",  ko: "필립스",             en: "Philips (Amsterdam)",           exchange: "EU",    sector: "의료기기" },
  { ticker: "AD.AS",    ko: "아홀드 델헤이즈",      en: "Ahold Delhaize (Amsterdam)",    exchange: "EU",    sector: "유통" },
  { ticker: "ENEL.MI",  ko: "에넬",               en: "Enel SpA (Milan)",              exchange: "EU",    sector: "유틸리티" },
  { ticker: "ENI.MI",   ko: "에니",               en: "ENI SpA (Milan)",               exchange: "EU",    sector: "에너지" },
  { ticker: "ISP.MI",   ko: "인테사 산파올로",      en: "Intesa Sanpaolo (Milan)",       exchange: "EU",    sector: "금융" },
  { ticker: "UCG.MI",   ko: "유니크레딧",          en: "UniCredit (Milan)",             exchange: "EU",    sector: "금융" },
  { ticker: "IBE.MC",   ko: "이베르드롤라",         en: "Iberdrola (Madrid)",            exchange: "EU",    sector: "유틸리티" },
  { ticker: "ITX.MC",   ko: "인디텍스 (자라)",      en: "Inditex (Zara) (Madrid)",       exchange: "EU",    sector: "패션" },
  { ticker: "ERIC-B.ST",ko: "에릭슨",             en: "Ericsson (Stockholm)",          exchange: "EU",    sector: "통신장비" },
  { ticker: "VOLV-B.ST",ko: "볼보",               en: "Volvo AB (Stockholm)",          exchange: "EU",    sector: "자동차/트럭" },
  ...
  { ticker: "7267.T",ko: "혼다 자동차",            en: "Honda Motor Co. (JP)",          exchange: "TSE",    sector: "자동차" },
  ...
  { ticker: "9434.T",ko: "소프트뱅크 Corp",       en: "SoftBank Corp (JP)",            exchange: "TSE",    sector: "통신" },
  { ticker: "MUFG",  ko: "미쓰비시 UFJ",          en: "Mitsubishi UFJ Financial",      exchange: "NYSE",   sector: "금융" },
  { ticker: "8306.T",ko: "미쓰비시 UFJ FG",       en: "Mitsubishi UFJ FG (JP)",        exchange: "TSE",    sector: "금융" },
  { ticker: "8316.T",ko: "미쓰이 스미토모 FG",     en: "Sumitomo Mitsui FG (JP)",       exchange: "TSE",    sector: "금융" },
  { ticker: "8411.T",ko: "미즈호 FG",             en: "Mizuho Financial Group (JP)",   exchange: "TSE",    sector: "금융" },
  { ticker: "TAK",   ko: "다케다 제약",            en: "Takeda Pharmaceutical",         exchange: "NYSE",   sector: "제약" },
  { ticker: "4502.T",ko: "다케다 제약 (JP)",       en: "Takeda Pharmaceutical (JP)",    exchange: "TSE",    sector: "제약" },
  ...
  { ticker: "4519.T",ko: "추가이 제약",            en: "Chugai Pharmaceutical (JP)",    exchange: "TSE",    sector: "제약" },
  { ticker: "4063.T",ko: "신에츠 화학",            en: "Shin-Etsu Chemical (JP)",       exchange: "TSE",    sector: "화학/반도체" },
  { ticker: "8035.T",ko: "도쿄 일렉트론",          en: "Tokyo Electron (JP)",           exchange: "TSE",    sector: "반도체장비" },
  { ticker: "6367.T",ko: "다이킨 공업",            en: "Daikin Industries (JP)",        exchange: "TSE",    sector: "공조/냉난방" },
  { ticker: "7751.T",ko: "캐논",                 en: "Canon Inc. (JP)",               exchange: "TSE",    sector: "카메라/프린터" },
  { ticker: "6501.T",ko: "히타치",               en: "Hitachi Ltd (JP)",              exchange: "TSE",    sector: "IT인프라" },
  { ticker: "6752.T",ko: "파나소닉",              en: "Panasonic Holdings (JP)",       exchange: "TSE",    sector: "전자" },
  { ticker: "7832.T",ko: "반다이남코",             en: "Bandai Namco Holdings (JP)",    exchange: "TSE",    sector: "게임/완구" },
  { ticker: "9766.T",ko: "코나미",               en: "Konami Group (JP)",             exchange: "TSE",    sector: "게임" },
  { ticker: "7270.T",ko: "후지 자동차",            en: "Subaru Corp (JP)",              exchange: "TSE",    sector: "자동차" },
  { ticker: "7201.T",ko: "닛산",                 en: "Nissan Motor (JP)",             exchange: "TSE",    sector: "자동차" },
  { ticker: "7261.T",ko: "마쓰다",               en: "Mazda Motor (JP)",              exchange: "TSE",    sector: "자동차" },
  { ticker: "9022.T",ko: "JR 동일본",             en: "East Japan Railway (JP)",       exchange: "TSE",    sector: "철도" },
  { ticker: "9020.T",ko: "JR 동해",              en: "Central Japan Railway (JP)",    exchange: "TSE",    sector: "철도" },
  { ticker: "4755.T",ko: "라쿠텐",               en: "Rakuten Group (JP)",            exchange: "TSE",    sector: "이커머스" },
  { ticker: "4689.T",ko: "야후 재팬",             en: "LY Corporation (Yahoo Japan)",  exchange: "TSE",    sector: "인터넷" },
  { ticker: "3382.T",ko: "세븐-일레븐 재팬",       en: "Seven & i Holdings (JP)",       exchange: "TSE",    sector: "유통" },
  { ticker: "8267.T",ko: "이온 그룹",             en: "AEON Co. Ltd (JP)",             exchange: "TSE",    sector: "유통" },
  { ticker: "2413.T",ko: "엠쓰리",               en: "M3 Inc. (JP)",                  exchange: "TSE",    sector: "의료IT" },
  { ticker: "4307.T",ko: "노무라 리서치",          en: "Nomura Research Institute (JP)",exchange: "TSE",    sector: "IT컨설팅" },
  { ticker: "6098.T",ko: "리크루트",              en: "Recruit Holdings (JP)",         exchange: "TSE",    sector: "HR/미디어" },
  { ticker: "2802.T",ko: "아지노모토",             en: "Ajinomoto Co. (JP)",            exchange: "TSE",    sector: "식품" },
  { ticker: "4901.T",ko: "후지필름",              en: "Fujifilm Holdings (JP)",        exchange: "TSE",    sector: "의료/사진" },
  { ticker: "5108.T",ko: "브리지스톤",             en: "Bridgestone Corp (JP)",         exchange: "TSE",    sector: "타이어" },
  { ticker: "285A.T",ko: "키옥시아 홀딩스",        en: "Kioxia Holdings (JP)",          exchange: "TSE",    sector: "반도체/NAND" },
  { ticker: "6920.T",ko: "레이저텍",              en: "Lasertec Corp (JP)",            exchange: "TSE",    sector: "반도체장비" },
  { ticker: "6146.T",ko: "디스코",               en: "Disco Corp (JP)",               exchange: "TSE",    sector: "반도체장비" },
  { ticker: "3436.T",ko: "섬코",                 en: "SUMCO Corp (JP)",               exchange: "TSE",    sector: "실리콘웨이퍼" },
  { ticker: "4385.T",ko: "메르카리",              en: "Mercari Inc. (JP)",             exchange: "TSE",    sector: "중고거래/핀테크" },
  { ticker: "3659.T",ko: "넥슨재팬",              en: "Nexon Co. (JP)",                exchange: "TSE",    sector: "게임" },
  { ticker: "9432.T",ko: "NTT",                 en: "Nippon Telegraph & Telephone",  exchange: "TSE",    sector: "통신" },
  { ticker: "9613.T",ko: "NTT 데이터",            en: "NTT Data Group (JP)",           exchange: "TSE",    sector: "IT서비스" },
  { ticker: "9433.T",ko: "KDDI",                en: "KDDI Corp (JP)",                exchange: "TSE",    sector: "통신" },
  { ticker: "9984.T",ko: "소프트뱅크 그룹",        en: "SoftBank Group Corp (JP)",      exchange: "TSE",    sector: "IT지주" },
  { ticker: "4543.T",ko: "테루모",               en: "Terumo Corp (JP)",              exchange: "TSE",    sector: "의료기기" },
  { ticker: "4523.T",ko: "에자이",               en: "Eisai Co. (JP)",                exchange: "TSE",    sector: "제약" },
  { ticker: "4151.T",ko: "쿄와 키린",             en: "Kyowa Kirin Co. (JP)",          exchange: "TSE",    sector: "제약/바이오" },
  { ticker: "7733.T",ko: "올림푸스",              en: "Olympus Corp (JP)",             exchange: "TSE",    sector: "의료기기/카메라" },
  { ticker: "8750.T",ko: "다이이치 생명",          en: "Dai-ichi Life Holdings (JP)",   exchange: "TSE",    sector: "생명보험" },
  { ticker: "8725.T",ko: "MS&AD 인슈어런스",      en: "MS&AD Insurance Group (JP)",    exchange: "TSE",    sector: "손해보험" },
  { ticker: "2269.T",ko: "메이지 홀딩스",          en: "Meiji Holdings Co. (JP)",       exchange: "TSE",    sector: "식품/제약" },
  { ticker: "7735.T",ko: "스크린 홀딩스",          en: "SCREEN Holdings Co. (JP)",      exchange: "TSE",    sector: "반도체장비" },
  { ticker: "6594.T",ko: "니덱",                 en: "Nidec Corp (JP)",               exchange: "TSE",    sector: "모터/정밀기계" },
  { ticker: "6971.T",ko: "쿄세라",               en: "Kyocera Corp (JP)",             exchange: "TSE",    sector: "전자부품" },
  { ticker: "4004.T",ko: "레조낙 홀딩스",         en: "Resonac Holdings (JP)",         exchange: "TSE",    sector: "화학/반도체소재" },
  { ticker: "5301.T",ko: "도카이 카본",            en: "Tokai Carbon Co. (JP)",         exchange: "TSE",    sector: "탄소소재" },
  { ticker: "6857.T",ko: "어드밴테스트",           en: "Advantest Corp (JP)",           exchange: "TSE",    sector: "반도체테스트" },
];
